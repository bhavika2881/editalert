...
if __name__ == '__main__':
    ...
    parser.add_argument('--model','--weights', type=str, default=ROOT / 'whitener_best.pt', help='model path or triton URL')
    ...
    parser.add_argument('--port', default=5500, type=int, help='port deployment')
