...
if __name__ == '__main__':
    ...
    parser.add_argument('--model','--weights', type=str, default=ROOT / 'overwriting_best.pt', help='model path or triton URL')
    ...
    parser.add_argument('--port', default=3000, type=int, help='port deployment')
